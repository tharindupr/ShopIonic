...
googleLoginService.factory('googleLogin', [
    ...
    function ($http, $q, $interval, $log, timeStorage) {
        ...
        service.redirect_url = 'http://127.0.0.1:81/ ';
        service.client_id = '234756189512-9jqag1kj4034ftpreq46aeda29avgcp0.apps.googleusercontent.com';
        service.secret = '0BxGwTi_WPx2II0o78f_jkBH';
